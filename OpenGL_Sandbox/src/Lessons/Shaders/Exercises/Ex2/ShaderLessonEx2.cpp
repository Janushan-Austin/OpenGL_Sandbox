...
// Using the Shader lesson template create a shader that applies a horizontal offset to the vertex position
int ShaderLessonEx2() {
	...
	Shader shaderTest("res/shaders/BasicShaders/HorizontalOffset.vert", "res/shaders/BasicShaders/VertexColorShader.frag");
