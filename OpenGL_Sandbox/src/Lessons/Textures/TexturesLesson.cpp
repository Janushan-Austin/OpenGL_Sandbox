...
int TexturesLesson() {
	...
	////bind our texture object to be the active texture object
	...
	//if (data) {
	//	//give openGL our texture image data to the active texture2D object
	...
	////free image memory generated by stb_image library
